...
<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
	<div class="kt-subheader   kt-grid__item" id="kt_subheader">
		<div class="kt-subheader__main">
			<h3 class="kt-subheader__title"><i class="la la-bicycle">
				Daftar Pengunjung</i>
			</h3>
		</div>
		...
		<table class="table table-striped- table-bordered table-hover table-checkable" id="listPengunjung">
			<thead style="text-align: center;">
				<tr class="font">
					...
					<th>Plat Nomor</th>
					<th>Jurusan</th>
					<th colspan="2">Waktu<br>Masuk&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Keluar</th>
					<th>Keterangan</th>
				</tr>
			</thead>
			<tbody style="text-align: center;">
				<?php $no = 1; foreach($detail as $det):
				if($det->keterangan == 'Masuk')
				{
					$masuk = date('d-m-Y H:i:s',strtotime($det->waktu));
					$keluar = 'Belum Keluar';
				}
				elseif($det->keterangan == 'Keluar')
				{
					$keluar = date('d-m-Y H:i:s',strtotime($det->waktu));
				}
				?>
				<tr class="font">
					<td><?php echo $no;?></td>
	...
	<div class="col-lg-12">
		<a href="<?php echo base_url()?>C_monitor/unduhpdf" class="btn btn-label-primary btn-wide btn-pill pull-right printidn"><i class="flaticon flaticon-download-1"></i>Download</a><br>
	</div>
</div>
